package edu.kh.exception.mdoel.service;
...
public class ExceptionService {
	...
	// 예외는 두 종류로 구분됨
	// 1) unchecked Exception : 선택적으로 예외 처리(ex. RuntimeExceptopm)
	...
	public void ex2() {
		...
		try {
			...
			// 다형성 업캐스팅에 의해 모든 후손 예외클래스를 잡아서 핮번에 처리가능!!!
	...
	public void ex3() {
		...
		// try-with-resources : finally에서 일일이 close() 호출하지 않아도 자동으로
		// 						리소스를 닫아주는 방식
