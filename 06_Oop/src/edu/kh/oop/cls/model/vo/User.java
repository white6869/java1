...
public class User {
	...
	// 기본생성자 자동완성 단추키 : ctrl + space -> enter
	...
	// 매개변수 생성자
	// ** 매개변수 : 생성자나 메서드 호출 시 () 안에 작성되어 전달되는 값을 저장하고 있는 변수
	...
	public User(String userId, String userPw, String userName, int userAge, String userGender) {
	...
	// 매개변수의 갯수가 같은것은 있으나 타입이 다름 -> 오버로딩 성립
	
	public User(String userId, int userAge) {}
	// 매개변수의 개수와 동일한것이 있으나, 하나의 타입이 다름 -> 오버로딩 성립
	
	public User(int userAge, String userId) {}
	// 매개벼눗의 개수, 타입은 같지만 순서가 다름 -> 오버로딩 성립
