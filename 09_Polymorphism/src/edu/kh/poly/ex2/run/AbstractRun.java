...
import edu.kh.poly.ex2.model.service.HGCalculator;
import edu.kh.poly.ex2.model.service.JHCalculator;
...
public class AbstractRun {
	...
	public static void main(String[] args) {
		...
		//Calculator cal = new JHCalculator();
		Calculator cal = new HGCalculator();
		...
		// - > 이를 이용하여 공동작업(팀프로젝트)에 필요한 개발환경 조성이 용이하다!
