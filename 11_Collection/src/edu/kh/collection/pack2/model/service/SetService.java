...
public class SetService {
	 ...
	 * - 중복 데이터, 저장 x
	 * 
	 * Set 인터페이시의 자식 크래스 1. MashSet(배포) : 처리 속다가 빠른 Set 2. LinkedHashSet : 순서를 유지하는
	 * Set 3. TreedSet : 자동 정렬되는 Set
	 * 
	 */
	...
	public void method1() {
		...
		// 1.booleqaen add(E e): 추가
		set.add("네이버"); // TrrSet은 ㅓㄷ
		set.add("카카오");
		set.add("라인");
		set.add("쿠팡");
		set.add("배달의민족");
		...
		// 6. boolean isEmpty() : 비어있으면 true, 없으면 false
	...
	public void method2() {
		...
		// Iterator set.iterator() : 현재 Set을 순차 접근 할 수 있는 Iterator 객체 반환
	...
	public void method3() {
		...
		// hashCode(), equals() 오버라이디 필수적으로 진행되어야 함!!!
		// **************************************************
	...
	public void method4() {
		...
		// 난수 생성
		// 1) Math.random()
		// 2) Random.nextInt(10) : 0~9 범위내 정수 반환 
